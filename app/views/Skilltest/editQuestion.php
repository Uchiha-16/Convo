        ...
        <div class="content-body">
            <div class="LHS">
                ...
                <div class="question-div add-event">
                    <form action="<?php echo URLROOT; ?>/SkillTest/edit" method="POST">
                        <table>
                                ...
                                <td colspan="3">
                                    ...
                                    <section>
                                        ...
                                        <div class="row row1">
                                            <div class="col col1">
                                                <textarea id="textarea1" class="inputform" type="text" name="question" placeholder="Describe the Question...." value="<?php echo $data['content']; ?>"></textarea>
                            ...
                            <tr>
                                ...
                                <select class="inputform" name="difficulty" style="font-size:14px;" required >
                                    <!-- <option value="none"hidden selected >-- Select Difficulty Level --</option> -->
