...
<body>
    ...
    <div class="container-div">
            <div class="content-body">
                ...
                <form action="<?php echo URLROOT; ?>/Profiles/expertedit" method="POST" class="form-field" enctype="multipart/form-data">
                    <!--Container-->
                    <div class="container-edit-profile">
                        <div class="left-profile-edit">
                            ...
                            <div class="form-div">
                                    ...
                                    <input type="text" id="designation" name="designation" class="form-control" value="<?php echo $data['expertprofile']->designation ?>">
                                    <span class="error"><?php echo $data['designation_err']; ?></span>
                            </div>

                            <div class="form-div">
                                    <label for="qualification">Add your Qualifications</label>
                                    <img class="normal-icon" src="<?php echo URLROOT; ?>/img/edit.png" alt="edit">
                                    <input type="text" id="qualification" name="qualification" class="form-control" value="<?php echo $data['expertprofile']->qualification ?>">
                                    <span class="error"><?php echo $data['qualification_err']; ?></span>
                            </div>

                            <div class="form-div">
                                    <label for="linkedin">Linkedin profile link</label>
                                    <img class="normal-icon" src="<?php echo URLROOT; ?>/img/edit.png" alt="edit">
                                    <input type="text" id="linkedin" name="linkedin" class="form-control" value="<?php echo $data['expertprofile']->linkedin ?>">
