    ...
    <?php elseif (($_SESSION['role']) == 'seeker/mod') : ?>
        ...
        <div class="nav">
            <?php if(isset($_SESSION['userID'])) : ?>
                ...
                <div class="nav-hover"><a href="<?php echo URLROOT; ?>/Webinars/home">Webinar</a></div>
                <div><input id="live_search_webinar" type="search" name="search" placeholder="Search by tag/ expert/ title" /></div>
                <div class="dropdown-list">
                    <button class="dropbtn dropbtn-1" onclick="drop()"><img src="<?php echo URLROOT; ?>/img/plus.png" class="icon"> Add New</button>
                    <div class="dropdown-content" id="myDropdown">
                ...
                <div class="nav-hover"><a href="<?php echo URLROOT; ?>/Chats/index"><img src="<?php echo URLROOT; ?>/img/chat.png" class="nav-icon"></a></div>
                <div class="dropbtn" onclick="drop2()"><img class="dropbtn" src="<?php echo URLROOT; ?>/img/profile.png" class="nav-icon" style="width: 25px;">
                <div class="dropdown-content dropdown-content2" id="myDropdown2">
                    <a href="<?php echo URLROOT;?>/Profiles/seeker">Profile</a>
                ...
                <div class="container-div">
                    <div class="content-body">
                        <div class="LHS" id="LHS">
                            ...
                            <div class="vid-slider">
                                <div class="vid-wrapper">
                                    ...
                                    <div class="video vid item">
                                        <div>
                                            <img src="<?php echo URLROOT; ?>/img/thumbnails/<?php echo $webinar->thumbnail ?>"
                                                class="thumbnail">
                                        </div>
                                        <iframe style="display:none;" width="550" height="325"
                                            src="https://www.youtube.com/embed/<?php echo $webinar->videolink ?>"
                                        ...
                                        <div>
                                            <div class="qdp">
                                                <div style="height: 100%;">
                                                    ...
                                                    <img
                                                        src="<?php echo URLROOT; ?>/img/pfp/<?php echo $webinar->pfp ?>" />
                                                    <?php else : ?>
                                                ...
                                                <div class="video-content">
                                                    ...
                                                    <div class="webinar-details">
                                                        ...
                                                        <div style="text-align: right;">
                                                            <span class="qdp-1-2 qdp-1-3">By
                                                                <?php echo $webinar->name ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="video-popup">
                                <div class="iframe-wrapper">
                                    <iframe width="800" height="500" src="" frameborder="0"
                        ...
                        <div class="RHS">
                            ...
                            <form action="<?php echo URLROOT; ?>/Webinars/add"><button type="submit" style="float:right"
                                    class="read-more attend">Create</button></form>
                            <form action="<?php echo URLROOT; ?>/Webinars/myWebinars"><button type="submit"
                                    style="float:right" class="read-more attend">My Videos</button></form>
                            <br><br><br><br><br>
                            <?php endif; ?>
                                ...
                                <form action="<?php echo URLROOT; ?>/webinars/filter" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <div class="checkbox-1">
                                            <span class="checkbox-title" onclick="filter2()">Publish date <i
                                                    class="arrow up" id="up2" style="margin-left: 4.3rem;"></i><i
                                                    class="arrow down" id="down2"
                                        ...
                                        <!-- Filter 3 -->
                                        <div class="checkbox-1">
                                            <span class="checkbox-title" onclick="filter3()">Expert <i class="arrow up"
