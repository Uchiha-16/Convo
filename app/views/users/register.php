...
<html lang="en">
    <head>
        ...
        <!-- stylesheets -->
        <link href="<?php echo URLROOT; ?>/css/style.css?version=1" rel="stylesheet" type="text/css"/> <link href="<?php echo URLROOT; ?>/css/signup.css?version=1" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <div class="grid">
            <div class="c1">
                ...
                <a href="../signup.php" id="choose"><p>&lt;&lt;Change Role&gt;&gt;</p></a><br>
            </div>
                    ...
                    <form name="" action="<?php echo URLROOT?>/Users/register" method="POST" enctype="multipart/form-data">
                        ...
                        <table>
                            <tr>
                                ...
                                <span class="error"><?php echo $data['fname_err']; ?></span></td>
                                <td class="left"><input type="text" placeholder="Last Name" name="lname" value="<?php echo $data['lname']; ?>" /><br><br>
                                <span class="error"><?php echo $data['lname_err']; ?></span></td>
                            </tr>
                            <tr>
                                <td colspan="2"><input type="email" placeholder="Email" name="email" value="<?php echo $data['email']; ?>"/><br><br>
                                <span class="error"><?php echo $data['email_err']; ?></span></td>
                            </tr>
                            <tr>
                                <td colspan="2"><input type="text" placeholder="Username" name="uname" value="<?php echo $data['uname']; ?>"/><br><br>
                                <span class="error"><?php echo $data['uname_err']; ?></span></td>
                            </tr>
                            <tr>
                                <td colspan="2" id='message' style="font-size:12px;"> </td>
                            </tr>
                            <tr>
                                <td class="right"><input type="password" placeholder="Password" name="password" id="p1" onkeyup='validate();' value="<?php echo $data['password']; ?>"/><br><br>
                                <span class="error"><?php echo $data['password_err']; ?></span></td>
                                <td class="left"><input type="password" placeholder="Re-enter Password" name="confirm_password" id="p2" onkeyup='validate();' value="<?php echo $data['confirm_password']; ?>"/><br><br>
                                <span class="error"><?php echo $data['confirm_password_err']; ?></span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p style="color: #19758D; font-weight:600; font-size:14px; margin:5px 0 0 0;">Already have an account? <a href="../login.php">Log In</a></p>
                                </td>
                            </tr>
                        </table>
                    </form>
