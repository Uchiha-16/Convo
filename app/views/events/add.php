                ...
                <div class="question-div add-event">
                    <form action="<?php echo URLROOT; ?>/Events/add" method="POST">
                        <table>
                            <tr>
                                <td colspan="3">
                                    <p class="desc">Make sure you did a research before adding an event. Enter a clear and concise Title and 
                                        Description that Experts will easily understand. Please provide any details experts may need to consider.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <section>
                                        ...
                                        <div class="row row1">
                                            <div class="col col1">
                                                <textarea id="textarea1" class="inputform" type="text" name="content" placeholder="Describe the Event...." value="<?php //echo $data['content']; ?>"></textarea>
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <input class="inputform" type="text" name="link" placeholder="Enter the Zoom Link recieved by the relavant expert..." value="<?php //echo $data['title']; ?>">
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <div class="add">
                                        ...
                                        <button style="float:right" class="read-more attend submit" type="submit" name="create">Schedule</button>
                                    </div>
                                </td>
                            </tr>
                        </table>
