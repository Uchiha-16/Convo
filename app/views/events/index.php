                    ...
                    <div class="question-div">
                        ...
                        <div class="content-display">
                            <div class="flex">
                                ...
                                <button class="read-more webinar time">3.00PM - 4.00PM</button>
                            </div><br>
                            <p>Resource person</p>
                            <div class="flex">
                                <div class="qdp">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="checkbox-1">
                                    ...
                                    <ul id="checkbox-2">
                                        <li>
                                            <label for="checkbox1">
                                                <input type="checkbox" value="last 3 months" name="publishDate[]" id="checkbox1" checked/>All
                                            </label>
                                        </li>     
                                        <li>
                                            <label for="checkbox2">
                                                <input type="checkbox" value="last 6 months" name="publishDate[]" id="checkbox2"/>Upcoming
                                            </label>
                                        </li>        
                                        <li>
                                            <label for="checkbox3">
                                                <input type="checkbox" value="last year" name="publishDate[]" id="checkbox3"/>Past
                                            </label>
                                        </li>
                                    </ul>
                                </div>
