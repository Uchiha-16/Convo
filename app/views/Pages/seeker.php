                    ...
                    <div>
                            ...
                            <div class="checkbox-1">
                                ...
                                <ul id="checkbox-3">
                                    <li>
                                        <label for="checkbox2">
                                            <input type="checkbox" value="Answered" name="QA[]" id="checkbox2" />Answered
                                        </label>
                                    </li>
                                    <li>
                                        <label for="checkbox3">
                                            <input type="checkbox" value="Not Answered" name="QA[]" id="checkbox3" />Not answered
                                        </label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="checkbox-1">
                                <span class="checkbox-title" onclick="filter4()">Rating <i class="arrow up" id="up4" style="margin-left: 6.7rem;"></i><i class="arrow down" id="down4" style="margin-left: 6.7rem;"></i></span>
                                    ...
                                    <ul id="checkbox-4">
                                        ...
                                        <li>
                                            <label for="checkbox3">
                                                <input type="checkbox" value="4" name="rating[]" id="checkbox3"/>4 Stars
                                            </label>
                                        </li>
                                        <li>
                                            <label for="checkbox3">
                                                <input type="checkbox" value="5" name="rating[]" id="checkbox3"/>5 Stars
                                            </label>
                                        </li>
                                    </ul>
